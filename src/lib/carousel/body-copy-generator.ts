...
import { computeCharacteristics, type GraphCharacteristics } from '../arc-classifier'
...
export { SLIDE_KEY_RE }
// computeCharacteristics + GraphCharacteristics moved to ../arc-classifier
// (shared with the arc-shape classifier). Re-exported so existing importers
// (tests, carousel callers) keep resolving them from here.
export { computeCharacteristics }
