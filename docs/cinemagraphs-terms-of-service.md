...
You can contact us by email at cinemagraphs.corp@gmail.com or by mail at:
...
1. You are the creator and owner of the User Content, or you have all necessary rights, licenses, consents, and permissions to submit the User Content and to grant the licenses described in Section 8
2. Your User Content does not and will not infringe, misappropriate, or violate any third party's intellectual property rights, publicity rights, privacy rights, contractual rights, or any other rights
3. Your User Content does not contain material that is illegal, harassing, hateful, harmful, defamatory, obscene, bullying, abusive, discriminatory, threatening, sexually explicit, false, inaccurate, deceitful, or misleading
4. Your User Content does not violate any applicable law or regulation
5. Your User Content does not include the personal information of any third party without their consent
6. Your User Content does not contain malware, viruses, or other harmful code
...
1. These Terms are between you and Cinemagraphs Corp only, not with Apple Inc. ("Apple"). Apple is not responsible for the application or its content.
2. Apple has no obligation to provide any maintenance or support services for the application.
3. If the application fails to conform to any applicable warranty, you may notify Apple, and Apple will refund the purchase price for the application (if any). To the maximum extent permitted by applicable law, Apple will have no other warranty obligation whatsoever with respect to the application.
...
5. In the event of any third-party claim that the application or your possession and use of the application infringes that third party's intellectual property rights, Cinemagraphs Corp, not Apple, will be solely responsible for the investigation, defense, settlement, and discharge of any such intellectual property infringement claim.
...
7. You must comply with applicable third-party terms of agreement when using the application (for example, your wireless data services agreement).
8. Apple and Apple's subsidiaries are third-party beneficiaries of these Terms, and upon your acceptance of these Terms, Apple will have the right (and will be deemed to have accepted the right) to enforce these Terms against you as a third-party beneficiary thereof.
...
1. These Terms are between you and Cinemagraphs Corp only, not with Google LLC ("Google"). Google is not responsible for the application or its content.
2. Your use of the application must also comply with Google Play's Terms of Service.
3. Google is not a party to these Terms and has no obligation to provide any support or maintenance for the application.
...
1. ERRORS, MISTAKES, OR INACCURACIES OF CONTENT AND MATERIALS, INCLUDING IN AI-GENERATED ANALYSIS
2. PERSONAL INJURY OR PROPERTY DAMAGE OF ANY NATURE WHATSOEVER, RESULTING FROM YOUR ACCESS TO AND USE OF THE SERVICES
3. UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS AND/OR ANY PERSONAL INFORMATION STORED THEREIN
4. INTERRUPTION OR CESSATION OF TRANSMISSION TO OR FROM THE SERVICES
5. BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE THAT MAY BE TRANSMITTED TO OR THROUGH THE SERVICES BY ANY THIRD PARTY
6. ERRORS OR OMISSIONS IN ANY CONTENT AND MATERIALS, OR FOR ANY LOSS OR DAMAGE OF ANY KIND INCURRED AS A RESULT OF THE USE OF ANY USER CONTENT POSTED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA THE SERVICES
...
5. Any User Content you submit to the Services
...
1. Any Disputes seeking to enforce or protect, or concerning the validity of, any intellectual property rights of a party
...
**Cinemagraphs Corp**
Email: cinemagraphs.corp@gmail.com
Mail: [BUSINESS ADDRESS — see notes at end of document before publishing], Canada
...
The following items still require your input or action. Resolve each before publishing this document at cinemagraphs.ca/terms.

## 1. Business address (Sections 1 introduction, Section 24)

Same issue as the Privacy Policy. Currently shows `[BUSINESS ADDRESS — see notes at end of document before publishing]`. Replace with:

- **Recommended**: Virtual mailbox address ($10-15/month services like iPostal1)
- **Acceptable**: Canada Post PO Box
- **Do not use**: Your home address (72 Goldbrook Crescent), for the same reasons explained in the Privacy Policy notes

Make sure the address matches what you use in the Privacy Policy.

## 2. Legal entity name "Cinemagraphs Corp"

Same issue as the Privacy Policy. Confirm one of:

- Cinemagraphs Corp is a registered Ontario or federal Canadian corporation. If so, no change needed.
- You're operating as a sole proprietorship. If so, replace "Cinemagraphs Corp" everywhere with just "Cinemagraphs" and clarify the legal entity in Section 24. Or incorporate before launch (~$300, a couple weeks).

Make sure the entity name matches the Privacy Policy.

## 3. DMCA agent contact (Section 10) — RESOLVED 2026-05-17

DMCA Designated Agent registration completed with the U.S. Copyright Office on 2026-05-17 (Registration Number DMCA-1072856). Section 10 was rewritten as "Copyright and DMCA Policy" with the registered agent block, full filing procedure under 17 U.S.C. § 512(c)(3), counter-notification procedure under § 512(g), repeat infringer policy, and § 512(f) misrepresentation notice. TERMS_VERSION bumped to 2026-05-17 to trigger fresh user acceptance on next app launch.

## 4. ADR Institute of Canada (Section 21)

I selected ADRIC (ADR Institute of Canada) as the arbitral body. It's Canada's primary arbitration institute, equivalent to AAA in the United States. Their rules are well-established for consumer disputes. This is the conventional choice for a Canadian consumer app.

Alternative if you want something different: you could specify "ad hoc arbitration in Toronto, Ontario under Ontario's Arbitration Act, 1991" without naming an institution. This is simpler but less structured. ADRIC is the safer default.

## 5. Account deletion option (Sections 3, 12)

Sections 3 and 12 reference "the account deletion option within the Services." Make sure the account deletion PR (the App Store Guideline 5.1.1(v) blocker in your queue) ships before you publish this document. Currently in mobile PR queue post-visual-polish.

If you publish before account deletion ships, you're claiming a feature you don't have. Two options:

- **Option A (recommended)**: Ship account deletion PR first, then publish Terms.
- **Option B**: Edit Sections 3 and 12 to say "by contacting us at cinemagraphs.corp@gmail.com to request account deletion" instead of mentioning an in-app option. Update the Terms once the in-app feature ships.

## 6. Hosting on cinemagraphs.ca/terms

Same approach as Privacy Policy. Create `app/terms/page.tsx` in your Next.js app. Both documents can share a layout. Add footer links to `/privacy` and `/terms` on the marketing site.

## 7. Cross-document consistency check

After both documents are finalized, do a final pass to make sure:

- Company name is consistent (Cinemagraphs Corp or just Cinemagraphs)
- Email is consistent (cinemagraphs.corp@gmail.com or whatever you switch to)
- Address is consistent
- Dates are consistent (both should show the actual publish date, not May 15 2026 if you publish later)
- Privacy Policy URL in Terms Section 16 is correct
